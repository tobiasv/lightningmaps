...
//en: 'Real Time'
$L['Real Time'] = 'W czasie rzeczywistym';

//en: 'Real-Time Lightning Map'
$L['Real-Time Lightning Map'] = 'Mapa wyładowań w czasie rzeczywystym';

//en: 'Delay'
$L['lm_live_delay'] = 'Opóźnienie';

//en: 'Strokes'
$L['lm_live_strokes'] = 'Wyładowania';

//en: 'Real-Time Lightning'
$L['lm_live_realtime'] = 'Wyładowania w czasie rzeczywistym';

//en: 'Settings'
$L['lm_live_settings_info'] = 'Ustawienia';

//en: 'Fullscreen'
$L['lm_live_set_fullscreen'] = 'Pełny ekran';

//en: 'on'
$L['lm_live_set_fullscreen_on'] = 'wł.';

//en: 'off'
$L['lm_live_set_fullscreen_off'] = 'wył.';

//en: 'Shows the map in fullscreen mode (only if your browser supports it).'
$L['lm_live_set_fullscreen_info'] = 'Pokazuje mapę w trybie pełnoekranowym (tylko jeśli Twoja przeglądarka go obsługuje).';

//en: 'Style'
$L['lm_live_set_map_style'] = 'Rodzaj mapy';

//en: 'Normal'
$L['lm_live_set_map_style_normal'] = 'Normalna';

//en: 'Satellite'
$L['lm_live_set_map_style_sat'] = 'Satelita';

//en: 'Terrain'
$L['lm_live_set_map_style_terrain'] = 'Teren';

//en: 'Roads'
$L['lm_live_set_map_style_roads'] = 'Drogi';

//en: 'Thunder'
$L['lm_live_set_thunder'] = 'Grzmoty';
...
//en: 'on'
$L['lm_live_set_clouds_on'] = 'wł.';

//en: 'off'
$L['lm_live_set_clouds_off'] = 'wył.';

//en: 'Clouds and precipitation from openweathermap.org (experimental!).'
$L['lm_live_set_clouds_info'] = 'Chmury i opad atmosferyczny z openweathermap.org (eksperymentalne!)';

//en: 'Radar'
$L['lm_live_set_radar'] = 'Radar';

//en: 'on'
$L['lm_live_set_radar_on'] = 'wł.';

//en: 'off'
$L['lm_live_set_radar_off'] = 'wył.';

//en: 'Rain radar is currently only available for the United States!'
$L['lm_live_set_radar_info'] = 'Radar opadów obecnie dostępny jest tylko dla Stanów Zjednoczonych!';

//en: 'Show Strokes'
$L['lm_live_set_strokes_show'] = 'Pokaż wyładowania';

//en: 'last hour'
$L['lm_live_set_strokes_show_all'] = 'ostatnia godzina';

//en: 'last minutes'
$L['lm_live_set_strokes_show_last'] = 'ostatnie minuty';

//en: 'Decide whether you want to see only "current" strokes or also those occurred up to an hour ago.'
$L['lm_live_set_strokes_show_info'] = 'Wybierz, czy chcesz widzieć tylko "aktualne" wyładowania, czy także te, które wystąpiły do godziny temu.';

//en: 'Stations: off'
$L['lm_live_stations_off'] = 'Stacje: wył.';
